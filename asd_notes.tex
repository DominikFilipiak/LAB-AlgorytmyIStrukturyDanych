...
\toprule
\multicolumn{1}{c}{\multirow{2}{*}{struktura}} & \multicolumn{2}{c}{$\Call{Access}{S, i}$} & \multicolumn{2}{c}{$\Call{Search}{S, x}$} & \multicolumn{2}{c}{$\Call{Insert}{S, x}$} & \multicolumn{2}{c}{$\Call{Delete}{S, x}$} \\ \cline{2-3} \cline{4-5} \cline{6-7} \cline{8-9} 
